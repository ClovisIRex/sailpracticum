...
%%%%------------ INPUTS ------------%%%%
chop_main='/Users/tal/University Code/practicum/new/arousalRatingV1.0_release/examples/CreativeIT_chopMain.txt'; % main file for chopping, listed as wav file, vad file (vad format: speech start, speech end)
